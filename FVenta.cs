    ...
    public partial class FVenta : Form
    {
        ...
        private void VentasPendientes()
        {
            string queryPendientes = "SELECT DISTINCT V.FolioVenta, FolioTicket Folio,  ISNULL(VD.Cantidad,0) Productos, V.FechaVenta, IIF(V.IdCliente = 0,V.NombreCliente, VC.Nombre) AS Cliente \n"
                                    ...
                                    " WHERE V.Valido = 1 AND V.Terminada = 0 AND V.IdSucursal = " + idSucursal + // AND V.EnEspera=1
                                    " AND V.Cancelado = 0 AND V.FolioVenta != '" + folioVenta + "' ORDER BY V.FolioVenta DESC";
        ...
        private void nuevaVenta()
        {
            ...
            var hayVentas = sqlLoc.scalar("  SELECT TOP(1) V.FolioVenta \n" //, FolioTicket Folio,  ISNULL(VD.Cantidad,0) Productos, V.FechaVenta
                                         ...
                                         + " WHERE V.Valido = 1 AND Cancelado = 0 AND V.Terminada = 0 AND V.IdSucursal = " + idSucursal + " AND ISNULL(VD.Cantidad,0) = 0 AND VP.Id IS NULL\n"
                                         + " ORDER BY V.Id DESC   ");
        ...
        private bool RegistrarPago()
        {
            ...
            double total = Convert.ToDouble(lblTotal.Text.Trim().Replace("Total:$","")) - (Convert.ToDouble(lblIVA.Text.Trim()) + Convert.ToDouble(lblIEPS.Text.Trim()));
        ...
        private void gvPendientes_Enter(object sender, EventArgs e)
        {
            ...
            gvPendientes.DefaultCellStyle.SelectionBackColor = Color.FromArgb(117, 150, 84); ;
        ...
        private void dgvVenta_Enter(object sender, EventArgs e)
        {
            ...
            dgvVenta.DefaultCellStyle.SelectionBackColor = Color.FromArgb(117, 150, 84); ;
        ...
        private void AbrirFacturacion()
        {
            ...
            string urlBase = "https://agape.ledsco.com.mx/FacturacionMasiva.aspx";
